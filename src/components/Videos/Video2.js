...
const Video2 = () => {
    ...
    useEffect(() => {
        console.log("userId in Video2:", id); 
        console.log("userData in Video2 useEffect:", userData); 
    ...
    function handleSubmit() {
        console.log("userData in Video2 handleSubmit:", userData); 
        navigate("/Question2", { state: { id, userData } });
    }

    console.log("user in Video2:", user); 
